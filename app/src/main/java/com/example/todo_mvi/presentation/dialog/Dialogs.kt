package com.example.todo_mvi.presentation.dialog
...
import com.example.todo_mvi.presentation.common.ThemeImageView
import com.example.todo_mvi.presentation.common.ThemeOutlineTextField
import com.example.todo_mvi.presentation.common.ThemePrimaryButton
import com.example.todo_mvi.ui.theme.ButtonGreen
        ...
        ConstraintLayout(
            ...
            Column(
                ...
                ThemeOutlineTextField(
                    ...
                    onValueChange = {
                        task.value = task.value.copy(taskDetails = it)
                    },
                    label = "Task Details",
                        ...
                        positiveClick = {
                            dateState.selectedDateMillis?.let {
                                task.value = task.value.copy(
                                    taskEndDate = SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault()).format(it)
                                )
                            }
                            showDialog = false
                        },
